    ...
    for d in dates:
        ...
        if round(len(data) / 17 - 1) == 31:
            ...
            Precipitation = pd.DataFrame(
                data[512:][1:], columns=['Precipitation'])
            ...
            Precipitation = pd.DataFrame(
                data[464:][1:], columns=['Precipitation'])
            print(str(str(d) + ' finished!'))
            ...
            Precipitation = pd.DataFrame(
                data[480:][1:], columns=['Precipitation'])
            print(str(str(d) + ' finished!'))
            ...
            Precipitation = pd.DataFrame(
                data[496:][1:], columns=['Precipitation'])
            print(str(str(d) + ' finished!'))
        else:
            print('Data not in normal length')

        dfs = [Date, Temperature, Dew_Point,
...
dates = ['2017-11', '2017-12','2018-1','2018-2']
page = 'https://www.wunderground.com/history/monthly/ie/ballygarvan/EICK/date/'
df_output = scraper(page, dates)

print(df_output)
df_output.to_csv('weather-raw.csv')